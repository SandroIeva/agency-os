        ...
        html: `
          <div style="font-family: -apple-system, BlinkMacSystemFont, 'Segoe UI', Roboto, sans-serif; max-width: 480px; margin: 0 auto; padding: 40px 20px; text-align: center;">
            <div style="margin-bottom: 32px;">
              <img src="https://agency-os-ebon-phi.vercel.app/logo-dark.svg" alt="i7 os" width="96" height="60" style="display: block; margin: 0 auto 16px;" />
              <h1 style="font-size: 22px; font-weight: 600; color: #1a1a2e; margin: 0;">You're invited to join the workspace</h1>
            </div>
            ...
            <a href="https://agency-os-ebon-phi.vercel.app/?invite=${token}" style="display: inline-block; padding: 12px 28px; background: #8B7AFF; color: white; text-decoration: none; border-radius: 10px; font-weight: 500; font-size: 14px; margin-bottom: 24px;">Join Workspace</a>
