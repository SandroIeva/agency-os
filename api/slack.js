...
const T = {
  de: {
    ...
    newEmpty: "Schreib dazu, was zu tun ist: /i7-task Angebot schreiben",
    noteMade: "Notiz gespeichert.",
    noteEmpty: "Schreib dazu, was du dir merken willst: /i7-note Preise anheben",
    ...
    slashHelp: "*Was ich kann*\n• `/i7-post` Beitrag auf Threads\n• `/i7-task` Neue Aufgabe anlegen\n• `/i7-note` Notiz aufschreiben\n• `/i7-status` Verbindung anzeigen\n\nEin Bild an mich geschickt landet in den Assets, auf einem Moodboard oder als Beitrag auf Instagram und Threads. Eine Adresse allein wird ein Lesezeichen.",
  ...
  en: {
    ...
    newEmpty: "Say what needs doing: /i7-task write the proposal",
    noteMade: "Note saved.",
    noteEmpty: "Say what you want to remember: /i7-note raise the prices",
    noteTitle: "New note",
    noteLabel: "Note",
    linkTitle: "Save link",
    ...
    slashHelp: "*What I can do*\n• `/i7-post` post to Threads\n• `/i7-task` create a task\n• `/i7-note` write a note\n• `/i7-status` show the connection\n\nSend me a picture and it goes to Assets, to a moodboard, or out as a post on Instagram and Threads. A bare url becomes a bookmark.",
