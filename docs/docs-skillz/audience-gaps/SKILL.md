...
2. Identify the 3 strongest questions a viewer would silently ask
3. For each: why they're asking + the three possible actions
4. Name the biggest gap — the one that most weakens the content if ignored
...
- Ground in audience insight where available — real pains beat guessed ones.
