# Social-Integrationen (Zernio: Analytics + Posting · SocialCrawl: öffentliche Profile)
...
- **Personenfoto**: kommt grundsätzlich an — `linkedin.com/in/williamhgates`
  lieferte sein Bild, geprüft damals in der inzwischen entfernten Benchmark-Zeile. Bei manchen Profilen fehlt es
