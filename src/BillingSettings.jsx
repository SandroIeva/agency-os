          ...
          <div>
            ...
            <div style={{ fontSize: 12, color: theme.textDim, marginTop: 5, lineHeight: 1.5 }}>
              {checkoutProcessing
                ...
                ? (de
                  ? `Du testest i7OS ${trial.lengthDays || TRIAL_DAYS} Tage lang mit allen ${PLAN_NAMES[TRIAL_PLAN]}-Funktionen, ${trial.daysLeft === 1 ? "noch 1 Tag" : `noch ${trial.daysLeft} Tage`}. Danach bleiben deine Inhalte erhalten, für Änderungen brauchst du einen Plan.`
                  : `You're trying i7OS for ${trial.lengthDays || TRIAL_DAYS} days with every ${PLAN_NAMES[TRIAL_PLAN]} feature, ${trial.daysLeft === 1 ? "1 day left" : `${trial.daysLeft} days left`}. Afterwards your content stays, but changes need a plan.`)
                : trial?.expired
                ? (de
