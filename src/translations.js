...
const translations = {
  ...
  "linearMenu.touchpoints":   { de: "Audience",         en: "Audience" },
  "linearMenu.creations":     { de: "Creations",        en: "Creations" },
  "linearMenu.assets":        { de: "Files Manager",    en: "Files Manager" },
  ...
  "assets.docs":              { de: "Dokumente",        en: "Documents" },
  // Empty-state
  ...
  "dash.yourTasks": { de: "Deine Aufgaben", en: "Your tasks" },
  "dash.whatsUp": { de: "Was steht an", en: "What's up" },
  "dash.newTaskTitle": { de: "Was ist zu tun?", en: "What needs doing?" },
  "dash.noProject": { de: "Ohne Projekt", en: "No project" },
  "dash.prioHigh": { de: "Hoch", en: "High" },
  "dash.prioMedium": { de: "Mittel", en: "Medium" },
  "dash.prioLow": { de: "Niedrig", en: "Low" },
  "dash.addTask": { de: "Hinzufügen", en: "Add" },
